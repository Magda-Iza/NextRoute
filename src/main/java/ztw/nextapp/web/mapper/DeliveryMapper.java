...
import ztw.nextapp.exceptions.NoSuchPersonException;
...
//        try {
//            String[] vehicleIds = deliveryDto.getVehicleIds().split(",");
//            List<Vehicle> vehicles = deliveryDto
//                .getVehicleIds()
//                .split(",")
//                .stream()
...
//                .person(personRepository.findById(deliveryDto.getDriverId()).get())
//                .employee(personRepository.findById(deliveryDto.getEmployeeId()).get())
//                .build();
//            return delivery;
//        } catch (Exception e) {
//            throw new NoSuchPersonException("No such person with id: " + deliveryDto.getDriverId() + " or " + deliveryDto.getEmployeeId());
//        }
//    }
